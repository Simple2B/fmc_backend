...
Revision ID: d61815b6d34a
Revises: 
Create Date: 2023-04-10 17:57:10.327549
...
def upgrade():
    ...
    sa.Column('stripe_customer_id', sa.String(length=32), nullable=True),
    ...
    sa.Column('message_type', sa.Enum('MESSAGE', 'REVIEW_COACH', name='messagetype'), nullable=True),
    ...
    op.create_table('student_favourite_coaches',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('coach_id', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['coach_id'], ['coaches.id'], ),
    sa.ForeignKeyConstraint(['schedule_id'], ['coach_schedules.id'], ),
    sa.ForeignKeyConstraint(['student_id'], ['students.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
